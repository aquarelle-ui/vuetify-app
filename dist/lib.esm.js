...
/* template */
var __vue_render__$u = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-list',[_c('v-list-tile',{attrs:{"avatar":""}},[_c('v-list-tile-avatar',[_c('image-icon',{attrs:{"letters-count":1,"src":_vm.user.avatar || _vm.user.name}})],1),_vm._v(" "),_c('v-list-tile-content',[_c('v-list-tile-title',{staticClass:"text--primary"},[_vm._v(_vm._s(_vm.user.name))]),_vm._v(" "),_c('v-list-tile-sub-title',[_vm._v(_vm._s(_vm.user.email))])],1),_vm._v(" "),_c('v-list-tile-action',[_c('v-menu',[_c('v-btn',{attrs:{"slot":"activator","icon":""},slot:"activator"},[_c('v-icon',[_vm._v("arrow_drop_down")])],1),_vm._v(" "),_c('v-list',[_c('v-list-tile',{on:{"click":function($event){}}},[_c('v-list-tile-avatar',[_c('v-icon',[_vm._v("person")])],1),_vm._v(" "),_c('v-list-tile-content',[_c('v-list-tile-title',[_vm._v("My account")])],1),_vm._v(" "),_c('v-list-tile-action')],1),_vm._v(" "),_c('v-divider'),_vm._v(" "),_c('v-list-tile',{on:{"click":function($event){$event.preventDefault();$event.stopPropagation();return _vm.signOut($event)}}},[_c('v-list-tile-avatar',[_c('v-icon',[_vm._v("exit_to_app")])],1),_vm._v(" "),_c('v-list-tile-content',[_c('v-list-tile-title',[_vm._v("Sign out")])],1),_vm._v(" "),_c('v-list-tile-action')],1)],1)],1)],1)],1),_vm._v(" "),_c('v-divider')],1)};
