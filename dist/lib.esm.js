...
function install$1(Vue) {
    Vue.directive('title', directive$1);
}
...
var __vue_staticRenderFns__$3 = [];
  ...
  var EntityTypeControl = normalizeComponent(
...
EntityTypeControl.install = function (Vue) {
    Vue.component(EntityTypeControl.name, EntityTypeControl);
    JsonForm.addControl('entity-type', new Parser(EntityTypeControl.name, null));
};
...
var __vue_staticRenderFns__$4 = [];
  ...
  var EntityInstanceControl = normalizeComponent(
...
EntityInstanceControl.install = function (Vue) {
    Vue.component(EntityInstanceControl.name, EntityInstanceControl);
    JsonForm.addControl('entity-instance', new Parser$1(EntityInstanceControl.name, null));
};
...
/* template */
var __vue_render__$r = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-app',{attrs:{"dark":_vm.dark}},[_vm._t("default")],2)};
...
/* template */
var __vue_render__$v = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-list',[_c('v-list-tile',{attrs:{"avatar":""}},[_c('v-list-tile-avatar',[_c('image-icon',{attrs:{"letters-count":1,"src":_vm.user.avatar || _vm.user.name}})],1),_vm._v(" "),_c('v-list-tile-content',[_c('v-list-tile-title',{staticClass:"text--primary"},[_vm._v(_vm._s(_vm.user.name))]),_vm._v(" "),_c('v-list-tile-sub-title',[_vm._v(_vm._s(_vm.user.email))])],1),_vm._v(" "),_c('v-list-tile-action',[_c('v-menu',{attrs:{"bottom":"","left":""}},[_c('v-btn',{attrs:{"slot":"activator","icon":""},slot:"activator"},[_c('v-icon',[_vm._v("arrow_drop_down")])],1),_vm._v(" "),_c('v-list',[_c('v-list-tile',{attrs:{"to":'/aquarelle/users/users/' + _vm.user.id + '/edit.html'}},[_c('v-list-tile-avatar',[_c('v-icon',[_vm._v("person")])],1),_vm._v(" "),_c('v-list-tile-content',[_c('v-list-tile-title',[_vm._v("My account")])],1),_vm._v(" "),_c('v-list-tile-action')],1),_vm._v(" "),_c('v-list-tile',{on:{"click":_vm.changeTheme}},[_c('v-list-tile-avatar',[_c('v-icon',[_vm._v("invert_colors")])],1),_vm._v(" "),_c('v-list-tile-content',[_c('v-list-tile-title',[_vm._v("Change theme")])],1),_vm._v(" "),_c('v-list-tile-action')],1),_vm._v(" "),_c('v-divider'),_vm._v(" "),_c('v-list-tile',{on:{"click":function($event){$event.preventDefault();$event.stopPropagation();return _vm.signOut($event)}}},[_c('v-list-tile-avatar',[_c('v-icon',[_vm._v("exit_to_app")])],1),_vm._v(" "),_c('v-list-tile-content',[_c('v-list-tile-title',[_vm._v("Sign out")])],1),_vm._v(" "),_c('v-list-tile-action')],1)],1)],1)],1)],1),_vm._v(" "),_c('v-divider')],1)};
...
/* template */
var __vue_render__$w = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.ready)?_c('router-view'):_c('app',[_c('v-container',{attrs:{"fluid":"","fill-height":""}},[_c('v-layout',{attrs:{"justify-center":"","align-center":""}},[_c('v-flex',{staticClass:"text-xs-center"},[_c('img',{staticStyle:{"max-width":"80%"},attrs:{"src":_vm.logo}}),_vm._v(" "),_c('v-progress-linear',{attrs:{"color":"secondary","indeterminate":""}}),_vm._v(" "),_c('v-flex',[_vm._v(_vm._s(_vm.status))])],1)],1)],1)],1)};
...
/* template */
var __vue_render__$x = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"show",rawName:"v-show",value:(false),expression:"false"}]},[_c('span',{directives:[{name:"dom-portal",rawName:"v-dom-portal",value:(_vm.titleSelector),expression:"titleSelector"}]},[(_vm.showBack)?_c('v-btn',{directives:[{name:"show",rawName:"v-show",value:(_vm.back.length > 0),expression:"back.length > 0"}],staticClass:"ml-0 mr-0",attrs:{"exact":"","small":"","icon":"","to":_vm.back}},[_c('v-icon',[_vm._v("arrow_back")])],1):_vm._e(),_vm._v("\n        "+_vm._s(_vm.title)+"\n    ")],1),_vm._v(" "),_c('div',{directives:[{name:"dom-portal",rawName:"v-dom-portal",value:(_vm.toolbarSelector),expression:"toolbarSelector"}]},[_vm._t("default")],2)])};
...
Vue.prototype.$app = App$1;
Vue.prototype.$user = User;

export { AceEditor, App$1 as App, AppDashboard, AppExtensionRoute, AppExtensions, AppLayout, AppMenu, AppNotifier, AppPage, AppRoot, AppToolbar, AppUser, BaseLoader, CacheLoader, CachedDataLoader, CloseDialogsBeforeLeave, CodeControl, ContentLoader, install as DOMPortalDirective, DataLoader, install$1 as DocumentTitleDirective, EntityChangeTitleDialog, EntityCloneDialog, EntityCreateForm, EntityDeleteDialog, EntityEditForm, EntityInstanceControl, Parser$1 as EntityInstanceParser, EntityList, ContextMenu as EntityListContextMenu, EntityListForm, EntityListLoadMixin, EntityListTemplate, EntityMixin, EntityTypeControl, Parser as EntityTypeParser, ExtendableError, FormMixin, ImageIcon, JsonFormControlsControl, JsonFormDisplay$1 as JsonFormDisplay, JsonFormDisplayControl, JsonFormDisplayElement, JsonFormDisplayElementMixin, JsonFormDisplayForm, JsonFormDisplayGroup, JsonFormDisplayItemWrapper, LetterAvatar, Loaders, LoginMixin, PageNotifier, PagerMixin, QuillEditor, Requestor, RichtextControl, Router, ServerError, ServerErrorMixin, entityCreateRoute, entityEditRoute, entityListRoute, onRouteLeave, permissionHook, permissionRoute };
